...
ggplot(old_people, aes(x=confidence_level)) + geom_bar() + labs(title = "Figure 5. Older Adults' Confidence Level on how the Pandemic was Handled", x = "Sliding Scale (1 being not confident, 10 being very confident)")


ggplot(old_people, aes(x=smaller_gathering_size)) + geom_bar() + labs(title = "Figure 6. Older Adults' Opinion on Smaller Gathering Sizes similar to Phase 1", x = "Sliding Scale (1 being not very effective, 10 being very effective)")
